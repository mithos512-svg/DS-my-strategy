...
session: 1
topic: What is a system, and why the "same" metric isn't always the same thing
status: bullet points ready — redesigned 09.08 to start from systems-thinking basics
created: 2026-08-09
language: en (team is English-speaking)
---

# Book Club, Session 1 — Bullet Points (EN, redesigned for a non-technical audience)
